...
public class FrmSystemUserManager extends JDialog implements ActionListener {
	...
	private Object tblTitle[]={"编号","账号","姓名","类型","注册时间"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnAdd){
			...
			if(JOptionPane.showConfirmDialog(this,"确定修改该管理员密码吗？","确认",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
				String userid=this.tblData[i][1].toString();
				FrmModifyPwd dlg=new FrmModifyPwd(this,"修改密码",true,userid);
				dlg.setVisible(true);
				this.reloadUserTable();
			}
		}
