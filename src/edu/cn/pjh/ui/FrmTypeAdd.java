...
public class FrmTypeAdd extends JDialog implements ActionListener{
private int bsnid;
	...
	public FrmTypeAdd(JDialog f, String s, boolean b,int bsnid) {
		super(f, s, b);
		this.bsnid=bsnid;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				PPutil.ProductTypesManager.createProductType(this.bsnid, name, content);;
				this.setVisible(false);
