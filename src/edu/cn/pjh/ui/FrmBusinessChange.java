...
public class FrmBusinessChange extends JDialog implements ActionListener{
private BeanBusiness business=null;
	...
	public FrmBusinessChange(JDialog f, String s, boolean b,BeanBusiness business) {
		super(f, s, b);
		...
		this.edtName.setText(business.getBusinessname());
		this.cmbStar.setSelectedIndex(business.getBusinessStar()-1);
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			this.business.setBusinessname(Name);
			this.business.setBusinessStar(star);
			try {
				PPutil.BusinessManager.changeBusiness(this.business);
				this.setVisible(false);
